...
const handlePayWithChapa = async () => {
  ...
  if (!checkout) {
    Alert.alert(
      "Checkout",
      "Your checkout is not ready yet.",
    );
    return;
  }
  ...
  try {
    ...
    if (Platform.OS === "web") {
      /*
       * Expo web:
       * Direct browser navigation is more reliable
       * than React Native Linking for external URLs.
       */
    ...
    /*
     * Android / iOS:
     * Open Chapa in the device browser.
     */
    const supported =
    ...
    if (!supported) {
      throw new Error(
        "Unable to open the Chapa payment page.",
      );
    }
    ...
    /*
     * For native, the user will return to RUuby
     * after completing payment.
     *
     * Automatic deep-link handling will be added
     * after we confirm the basic payment flow works.
     */
    Alert.alert(
      "Payment",
      "After completing your payment in Chapa, return to RUuby and tap Verify Payment.",
      [
        {
          text: "Cancel",
          style: "cancel",
